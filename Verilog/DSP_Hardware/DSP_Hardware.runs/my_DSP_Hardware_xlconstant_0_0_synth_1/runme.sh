...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/DSP_Hardware/DSP_Hardware.runs/my_DSP_Hardware_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_DSP_Hardware_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_DSP_Hardware_xlconstant_0_0.tcl
