...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FCLK_CLK0_50MHz [ create_bd_port -dir O -type clk FCLK_CLK0_50MHz ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {49999996} \
 ] $FCLK_CLK0_50MHz
  set FCLK_CLK1_100MHz [ create_bd_port -dir O -type clk FCLK_CLK1_100MHz ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {99999992} \
 ] $FCLK_CLK1_100MHz
  set FCLK_CLK2_200MHz [ create_bd_port -dir O -type clk FCLK_CLK2_200MHz ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {199999985} \
 ] $FCLK_CLK2_200MHz
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0_50MHz] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1_100MHz] [get_bd_pins processing_system7_0/FCLK_CLK1]
