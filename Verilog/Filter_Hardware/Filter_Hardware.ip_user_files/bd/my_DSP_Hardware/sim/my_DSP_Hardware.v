...
(* CORE_GENERATION_INFO = "my_DSP_Hardware,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=my_DSP_Hardware,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "my_DSP_Hardware.hwdef" *) 
module my_DSP_Hardware
  ...
  my_DSP_Hardware_my_DA_Converter_0_0 my_DA_Converter_0
       (.adc_clk(my_AD_Converter_0_adc_clk),
        ...
        .dat_a_i(my_Filter_0_P_OUT16),
        .dat_b_i(my_AD_Converter_0_adc_dat_a),
        .rstn_i(Net));
  my_DSP_Hardware_my_Filter_0_0 my_Filter_0
       (.B_IN(my_Vector_Length_Mod_0_output_vector),
        .CLK(my_AD_Converter_0_adc_clk),
        .P_OUT16(my_Filter_0_P_OUT16),
        .RST(Net));
