...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/Filter_Hardware/Filter_Hardware.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_DSP_Hardware_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_DSP_Hardware_wrapper.tcl -notrace
