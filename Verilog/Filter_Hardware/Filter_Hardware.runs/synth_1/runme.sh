...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/Filter_Hardware/Filter_Hardware.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_DSP_Hardware_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_DSP_Hardware_wrapper.tcl
