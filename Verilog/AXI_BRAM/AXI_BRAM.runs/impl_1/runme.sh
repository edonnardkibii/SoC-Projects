...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/AXI_BRAM/AXI_BRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_BRAM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_BRAM_wrapper.tcl -notrace
