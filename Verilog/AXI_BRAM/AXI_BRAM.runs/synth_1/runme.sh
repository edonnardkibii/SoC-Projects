...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/AXI_BRAM/AXI_BRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_BRAM_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_BRAM_wrapper.tcl
