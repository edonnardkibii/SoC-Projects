...
//Date        : Wed Dec 16 16:44:09 2020
//Host        : LAPTOP-8T04MTTM running 64-bit major release  (build 9200)
//Command     : generate_target AXI_BRAM.bd
//Design      : AXI_BRAM
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "AXI_BRAM,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=AXI_BRAM,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "AXI_BRAM.hwdef" *) 
module AXI_BRAM
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > AXI_BRAM blk_mem_gen_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  AXI_BRAM_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  AXI_BRAM_axi_bram_ctrl_1_0 axi_bram_ctrl_1
  ...
  AXI_BRAM_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  (* BMM_INFO_PROCESSOR = "arm > AXI_BRAM axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  AXI_BRAM_processing_system7_0_0 processing_system7_0
  ...
  AXI_BRAM_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
