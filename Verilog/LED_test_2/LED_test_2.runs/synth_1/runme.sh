...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/LED_test_2/LED_test_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ledctrl_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ledctrl_top.tcl
