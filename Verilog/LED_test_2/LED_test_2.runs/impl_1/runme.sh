...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/LED_test_2/LED_test_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ledctrl_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ledctrl_top.tcl -notrace
