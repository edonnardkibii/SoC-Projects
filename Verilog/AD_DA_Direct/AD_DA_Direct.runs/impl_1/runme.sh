...
HD_PWD='C:/Users/James Kibii/OneDrive/Dokumente/Vivado/AD_DA_Direct/AD_DA_Direct.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_AD_DA_Direct_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_AD_DA_Direct_wrapper.tcl -notrace
