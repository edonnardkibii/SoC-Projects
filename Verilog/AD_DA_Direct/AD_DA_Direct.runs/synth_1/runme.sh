...
HD_PWD='C:/Users/James Kibii/OneDrive/Dokumente/Vivado/AD_DA_Direct/AD_DA_Direct.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_AD_DA_Direct_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_AD_DA_Direct_wrapper.tcl
