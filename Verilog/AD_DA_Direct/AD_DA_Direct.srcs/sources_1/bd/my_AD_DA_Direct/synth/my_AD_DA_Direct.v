...
//Date        : Thu Nov 19 00:46:22 2020
//Host        : LAPTOP-8T04MTTM running 64-bit major release  (build 9200)
//Command     : generate_target my_AD_DA_Direct.bd
//Design      : my_AD_DA_Direct
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "my_AD_DA_Direct,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=my_AD_DA_Direct,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "my_AD_DA_Direct.hwdef" *) 
module my_AD_DA_Direct
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  my_AD_DA_Direct_my_AD_Converter_0_0 my_AD_Converter_0
  ...
  my_AD_DA_Direct_my_DA_Converter_0_0 my_DA_Converter_0
       (.adc_clk(my_AD_Converter_0_adc_clk),
        ...
        .dat_a_i(my_AD_Converter_0_adc_dat_a),
        .dat_b_i(my_AD_Converter_0_adc_dat_b),
        .rstn_i(processing_system7_0_FCLK_RESET0_N));
  my_AD_DA_Direct_processing_system7_0_0 processing_system7_0
