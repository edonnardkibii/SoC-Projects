...
(* CORE_GENERATION_INFO = "my_AD_DA_Exp,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=my_AD_DA_Exp,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=4,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "my_AD_DA_Exp.hwdef" *) 
module my_AD_DA_Exp
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  my_AD_DA_Exp_processing_system7_0_0 processing_system7_0
