...
HD_PWD='/home/pabele/HTWG/Skripte/SoC/Labor_Vorlesung/02d_Block_Design_erzeugen/Vivado_Projekte/AD_DA_Exp/AD_DA_Exp.runs/my_AD_DA_Exp_my_AD_Converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_AD_DA_Exp_my_AD_Converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_AD_DA_Exp_my_AD_Converter_0_0.tcl
