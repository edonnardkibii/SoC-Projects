...
HD_PWD='/home/pabele/HTWG/Skripte/SoC/Labor_Vorlesung/02d_Block_Design_erzeugen/Vivado_Projekte/AD_DA_Exp/AD_DA_Exp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_AD_DA_Exp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_AD_DA_Exp_wrapper.tcl -notrace
