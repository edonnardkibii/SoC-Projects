...
HD_PWD='C:/Users/kibii/OneDrive/Studienkolleg/Vivado/AD_DA_Exp/AD_DA_Exp.runs/my_AD_DA_Exp_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_AD_DA_Exp_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_AD_DA_Exp_processing_system7_0_1.tcl
